    ...
    <div class="m-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('admin.censor-complain.index') }}" class="row gx-3 m-2">
                    <div class="col-lg-8 col-12 mb-2">
                        <input type="text" name="search" class="form-control" placeholder="Tìm kiếm yêu cầu khiếu nại"
