                                    ...
                                    <td>
                                        <span class="dropdown dropstart">
                                            ...
                                            <span class="dropdown-menu">
                                                ...
                                                <a href="javascript:void(0)" class="dropdown-item" onclick="confirmDelete({{ $user->id }})">
                                                    <svg class="w-10 me-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                        class="size-6">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                <form id="delete-tag-{{ $user->id }}" action="{{ route('users.destroy', $user->id) }}" method="POST" style="display:none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </span>
