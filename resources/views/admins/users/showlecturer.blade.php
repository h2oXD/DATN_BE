                ...
                <div class="mb-4">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-warning text-dark text-center" value="Giảng viên"
                                readonly>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ number_format($totalRevenue, 0, ',', '.') }} VNĐ" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold">Lợi nhuận giảng viên</label>
                                <input type="text" class="form-control"
                                    value="{{ number_format($totalLecturerEarning, 0, ',', '.') }} VNĐ" readonly>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold">Lợi nhuận hệ thống</label>
                                <input type="text" class="form-control"
                                    value="{{ number_format($totalAdminEarning, 0, ',', '.') }} VNĐ" readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped align-middle">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center text-muted py-3">Không có khóa học nào.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
