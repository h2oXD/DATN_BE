                                ...
                                <td>
                                    <div class="d-flex align-items-center flex-row gap-2">
                                        <div class="position-relative">
                                            <img src="{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : asset('assets/images/avatar/avatar-3.jpg') }}" alt="avatar"
                                ...
                                <td>
                                    <span class="dropdown dropstart">
                                        ...
                                        <span class="dropdown-menu">
                                            ...
                                            <a href="{{ route('admin.users.showstudent', $user->id) }}" class="dropdown-item">
