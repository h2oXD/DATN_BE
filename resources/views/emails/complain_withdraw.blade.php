...
<head>
    ...
    <title>Thông báo kết quả yêu cầu rút tiền</title>
...
<body>
    <div class="email-container">
        <div class="email-header">
            <h1>Thông báo kết quả giải quyết yêu cầu khiếu nại</h1>
        </div>
        <div class="email-body">
            <h2>Kính gửi {{ $user->name }}</h2>
            <p>Chúng tôi xin thông báo rằng yêu cầu khiếu nại của quý khách đã được chúng tôi kiểm tra và giải quyết với kết quả là:
            </p>
            <p><strong>
                    @if ($statusComplain === 'resolved')
                        ĐÃ GIẢI QUYẾT
                    @elseif($statusComplain === 'rejected')
                        TỪ CHỐI
                    @endif
                </strong></p>
            <p>
                Phản hồi từ người kiểm duyệt: <strong>{{ $feedback }}</strong>
            </p>
