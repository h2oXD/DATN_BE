...
<head>
    ...
    <title>Thông báo từ chối khóa học</title>
...
<body>
    <div class="email-container">
        <div class="email-header">
            <h1>Thông báo từ chối khóa học</h1>
        </div>
        <div class="email-body">
            <h2>Xin chào {{ $notifiable->name }}</h2>
            <p>Chúng tôi rất tiếc phải thông báo rằng khóa học "<strong>{{ $course->title }}</strong>" của bạn chưa đạt yêu cầu phê duyệt.</p>
            @if (!empty($reason))
                <div class="reason-box">
                    <p><strong>Lý do từ chối:</strong> {{ $reason }}</p>
                </div>
            @endif
            <p>Vui lòng xem xét chỉnh sửa nội dung khóa học theo phản hồi trên và gửi lại yêu cầu phê duyệt. Nếu bạn cần hỗ trợ thêm, đội ngũ chúng tôi luôn sẵn sàng!</p>
            {{-- <p><a href="{{ url('/') }}" class="cta-button">Chỉnh sửa ngay</a></p> --}}
            <p>Trân trọng,</p>
