                ...
                <div class="col-lg-5 col-md-8 py-8 py-xl-0">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body p-6 d-flex flex-column gap-4">
                            <div>
                                <a href="../index.html"><img src="../assets/images/brand/logo/logo-icon.svg"
                            ...
                            <form class="needs-validation" novalidate>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" id="signInEmail" class="form-control" name="signInEmail"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" id="signInPassword" class="form-control"
                                        name="signInPassword" placeholder="**************" required />
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Jan 2025 13:53:58 GMT -->
