...
class CourseReject extends Notification implements ShouldQueue, ShouldBroadcast
{
    use Queueable;
    ...
    {
        return (new MailMessage)->subject('Thông báo từ chối khóa học')
            ->view('emails.course_reject', [
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => 'Khóa học "' . $this->course->title . '" đã bị từ chối.',
            'type' => 'reject_course',
