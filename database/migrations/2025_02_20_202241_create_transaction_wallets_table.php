...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('transaction_wallets', function (Blueprint $table) {
            ...
            $table->enum('type', ['deposit', 'withdraw', 'profit', 'payment', 'refund'])->comment('Nạp tiền, rút tiền, lợi nhuận, thanh toán');
            ...
            $table->timestamp('censor_date')->nullable()->comment('Ngày kiểm duyệt');

            $table->string('note')->nullable()->comment('Ghi chú giao dịch');
            $table->boolean('complain')->default(false)->comment("Có khiếu nại hay không");
            $table->timestamp('time_limited_complain')->nullable()->comment('Hạn chót khiếu nại');
